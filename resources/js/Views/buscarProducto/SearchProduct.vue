                ...
                <div class="box-wrapper">
                    ...
                    <div class="box-sidebar pb-3 shadow-sm" :class="{ 'open': isSidebar }">
                        ...
                        <v-expansion-panels class="py-0" flat>
                            <v-expansion-panel class="pa-0">
                                ...
                                <v-expansion-panel-content>
                                    <div class="mb-2">
                                        <a href="#" class="text-decoration-none grey--text text--darken-2 ms-6 ">Bubble
                                            Path</a>
                                    </div>
                                    <div>
                                        <a href="#" class="text-decoration-none grey--text text--darken-2 ms-6">Bubble
                        ...
                        <div class="mx-6 pt-3">
                            ...
                            <v-range-slider class=" mt-10" :value="[1, 2]" min="0" max="3" tick-size="4">
                            ...
                            <div v-for="(category, index) in getCategory" :key="index">
                                <v-checkbox hide-details @change="filterCategory(category)" class="mt-3" v-model="selected"
                                    :label="category.title" :value="category.title"></v-checkbox>
                            </div>
                            ...
                            <div v-for="(sidebarRating) in getRatings" :key="sidebarRating.id">
                                ...
                                >  
                                    ...
                                    <v-rating :value="sidebarRating.rates" background-color="amber" color="amber" dense
                                        half-increments readonly size="19"></v-rating>
                                </div>
                            </div>
                                    ...
                                    <v-data-iterator :items="itemSearch" :items-per-page.sync="itemsPerPage" :page.sync="page"
                                        ...
                                        <template v-slot:footer>
                                            ...
                                            grey--text">
                                                ...
                                                <v-btn fab :disabled="page == numberOfPages" small color="primary"
...
import CardCart from "../../assets/components/cartCard/CardCart.vue";
export default {
    components: {
        CardCart
    },
    ...
    methods: {
        ...
        filterCategory(category) {
            this.itemsBySearch = this.getProducts.filter(x => this.selected.includes(x.category))
        ...
        productRate(rate) {
            ...
            this.itemsBySearch = this.getProducts.filter(x => x.rating == rate.rates)
