                            ...
                            <v-col cols="12" md="6" lg="8" xl="8">
                                ...
                                >
                                    <base-card class="d-flex flex-wrap mb-6">
                                        ...
                                        >
                                            <div
                                                class="d-flex justify-space-between w-100 mb-3"
                                            >
                                                <div>
                                                    <div
                                                        class="d-flex"
                                                        :style="
                                                            $vuetify.breakpoint
                                                                .xs
                                                                ? `width: 300px; height: 100px; word-wrap: break-word; word-break: break-all; padding-right: 30px;`
                                                                : ''
                                                        "
                                                    >
                                                        <h4
                                                    ...
                                                    <div>
                                                        <p
                                                            class="grey--text text--darken-1 mb-0"
                                                        >
                                                            ${{
                                                                n.amount
                                                                    | numberFormat
                                            ...
                                            <div
                                                class="d-flex justify-end flex-grow-1 align-end"
                                            >
                                                <div
                                    ...
                                    <div class="pa-5">
                                        ...
                                        >
                                            ...
                                            <h4 class="font-600 mb-0">
                                                ${{
                                                    computed_factura.total_factura
                                                        | numberFormat
                                                }}
                                            </h4>
                                        </div>
...
export default {
    ...
    methods: {
        ...
        async deliverOrder() {
            try {
                var items = this.getCartProducts;
                this.computed_factura.items = items;
                let { data } = await axios.post(
                    "/api/ordenar-pedido",
                    this.computed_factura
                );
                localStorage.setItem(
                    "dataFactura",
                    JSON.stringify(this.computed_factura)
                );
                this.$router.push({ name: "home" });
                this.computed_snack = true;
